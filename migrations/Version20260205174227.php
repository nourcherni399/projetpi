 ...
 */
final class Version20260205174227 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module ADD categorie VARCHAR(255) NOT NULL, CHANGE niveau niveau ENUM(\'difficile\', \'moyen\', \'facile\') NOT NULL');
