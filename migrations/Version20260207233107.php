 ...
 */
final class Version20260207233107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favori_module (id INT AUTO_INCREMENT NOT NULL, date_ajout DATETIME NOT NULL, user_id INT NOT NULL, module_id INT NOT NULL, INDEX IDX_5D64EA3DA76ED395 (user_id), INDEX IDX_5D64EA3DAFC2B591 (module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE favori_module ADD CONSTRAINT FK_5D64EA3DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE favori_module ADD CONSTRAINT FK_5D64EA3DAFC2B591 FOREIGN KEY (module_id) REFERENCES module (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE favori_module DROP FOREIGN KEY FK_5D64EA3DA76ED395');
        $this->addSql('ALTER TABLE favori_module DROP FOREIGN KEY FK_5D64EA3DAFC2B591');
        $this->addSql('DROP TABLE favori_module');
        $this->addSql('ALTER TABLE blog CHANGE type type ENUM(\'recommandation\', \'plainte\', \'question\', \'experience\') NOT NULL');
