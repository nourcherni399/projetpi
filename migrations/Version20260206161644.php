 ...
 */
final class Version20260206161644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Disponibilite: n'altérer 'jour' que si la colonne existe (certaines BDD ont déjà migré vers 'date')
        $schemaManager = $this->connection->createSchemaManager();
        $dispoColumns = $schemaManager->listTableColumns('disponibilite');
        if (isset($dispoColumns['jour'])) {
        ...
        $this->addSql('ALTER TABLE user ADD confirmation_token VARCHAR(255) DEFAULT NULL, ADD token_expires_at DATETIME DEFAULT NULL, CHANGE role role ENUM(\'ROLE_ADMIN\', \'ROLE_PARENT\', \'ROLE_PATIENT\', \'ROLE_MEDECIN\', \'ROLE_USER\')');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP confirmation_token, DROP token_expires_at, CHANGE role role ENUM(\'ROLE_ADMIN\', \'ROLE_PARENT\', \'ROLE_PATIENT\', \'ROLE_MEDECIN\', \'ROLE_USER\') DEFAULT NULL');
    }
}
