 ...
 */
final class Version20260301154207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE module_bookmark (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, user_id INT NOT NULL, module_id INT NOT NULL, INDEX IDX_BEA241E3A76ED395 (user_id), INDEX IDX_BEA241E3AFC2B591 (module_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE module_bookmark ADD CONSTRAINT FK_BEA241E3A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE module_bookmark ADD CONSTRAINT FK_BEA241E3AFC2B591 FOREIGN KEY (module_id) REFERENCES module (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module_bookmark DROP FOREIGN KEY FK_BEA241E3A76ED395');
        $this->addSql('ALTER TABLE module_bookmark DROP FOREIGN KEY FK_BEA241E3AFC2B591');
