 ...
 */
final class Version20260217155704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commentaire (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, is_published TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, date_modif DATETIME DEFAULT NULL, user_id INT DEFAULT NULL, blog_id INT NOT NULL, INDEX IDX_67F068BCA76ED395 (user_id), INDEX IDX_67F068BCDAE07E97 (blog_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE disponibilite (id INT AUTO_INCREMENT NOT NULL, heure_debut TIME NOT NULL, heure_fin TIME NOT NULL, date DATE NOT NULL, duree INT DEFAULT 0 NOT NULL, est_dispo TINYINT(1) DEFAULT 1 NOT NULL, medecin_id INT DEFAULT NULL, INDEX IDX_2CBACE2F4F31A84 (medecin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE module (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, contenu VARCHAR(255) NOT NULL, niveau ENUM(\'difficile\', \'moyen\', \'facile\') NOT NULL, image VARCHAR(255) NOT NULL, is_published TINYINT(1) NOT NULL, date_creation DATETIME NOT NULL, date_modif DATETIME NOT NULL, categorie ENUM(\'\', \'COMPRENDRE_TSA\', \'AUTONOMIE\', \'COMMUNICATION\', \'EMOTIONS\', \'VIE_QUOTIDIENNE\', \'ACCOMPAGNEMENT\') NOT NULL, admin_id INT DEFAULT NULL, INDEX IDX_C242628642B8210 (admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
