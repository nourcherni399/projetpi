 ...
 */
final class Version20260209165153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement DROP location_url, CHANGE lieu lieu VARCHAR(255) NOT NULL');
        ...
        $this->addSql('ALTER TABLE thematique DROP image, CHANGE public_cible public_cible ENUM(\'Enfant\', \'Parent\', \'Médecin\', \'Éducateur\', \'Aidant\', \'Autre\'), CHANGE niveau_difficulte niveau_difficulte ENUM(\'Débutant\', \'Intermédiaire\', \'Avancé\')');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evenement ADD location_url VARCHAR(500) DEFAULT NULL, CHANGE lieu lieu VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE thematique ADD image VARCHAR(500) DEFAULT NULL, CHANGE public_cible public_cible ENUM(\'Enfant\', \'Parent\', \'Médecin\', \'Éducateur\', \'Aidant\', \'Autre\') DEFAULT NULL, CHANGE niveau_difficulte niveau_difficulte ENUM(\'Débutant\', \'Intermédiaire\', \'Avancé\') DEFAULT NULL');
