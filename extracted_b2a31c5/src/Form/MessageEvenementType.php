...
final class MessageEvenementType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('contenu', TextareaType::class, [
            'label' => 'Votre message',
            'constraints' => [
                new NotBlank(message: 'Le message ne peut pas ├¬tre vide.'),
                new Length(['max' => 5000, 'maxMessage' => 'Le message ne peut pas d├®passer {{ limit }} caract├¿res.']),
            ],
            'attr' => $attr + ['placeholder' => '├ëcrivez votre question ou messageÔÇª'],
        ]);
    }
