...
class MessageEvenement
{
    ...
    /** Participant de la conversation (utilisateur inscrit ou ayant ├®crit). */
    #[ORM\ManyToOne]
    #[ORM\JoinColumn(nullable: false, onDelete: 'CASCADE')]
    private ?User $user = null;

    #[ORM\Column(type: Types::TEXT)]
    #[Assert\NotBlank(message: 'Le message ne peut pas ├¬tre vide.')]
    #[Assert\Length(max: 5000, maxMessage: 'Le message ne peut pas d├®passer {{ limit }} caract├¿res.')]
